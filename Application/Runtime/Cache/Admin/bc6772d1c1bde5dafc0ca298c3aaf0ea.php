          ...
          <div class="page-content">
            <div class="row">
              <div class="page-content box">
                ...
                <form action="/commpany/build/index.php/Admin/Set/updateperson" method="post" class="form-horizontal" enctype="multipart/form-data">
                  <div class="form-group">
                    <label class="control-label">联系人名称 : </label>
                    <div class="controls pull-left">
                      <input type="text"  name="linkman"  value="<?php echo ($vo["linkman"]); ?>" class="input-large">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label">联系手机 : </label>
                    <div class="controls pull-left">
                      <input type="text" name="phone"  value="<?php echo ($vo["phone"]); ?>" class="input-large">
                      <span class="help-inline"></span> </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label">联系地址: </label>
                    <input type="text" name="address"  value="<?php echo ($vo["address"]); ?>" class="input-large">
                  </div>
