    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
              ...
              <h4><span style="float:right;"><a href='/commpany/build/index.php/Admin/Type/index'>返回</a></span></h4>
                    <div class="span10">
                        <h3><i class="icon-magic"></i>添加子分类</h3>
                    </div>
                </div>
                  <form action="/commpany/build/index.php/Admin/Type/insertchild" method="post" class="form-horizontal">
                      <?php if(($res1)): ?><div class="form-group">
                          <label class="control-label">一级分类名 : </label>
                          <div class="controls pull-left">
                              <input type="text" disabled="disabled" class="input-large"  value="<?php echo ($res1["type"]); ?>">
                          </div>
                      </div>
                      <?php else: endif; ?>

                      <div class="form-group">
                          <label class="control-label">父分类名 : </label>
                          <div class="controls pull-left">
                              <input type="text" disabled="disabled" class="input-large" name="type" value="<?php echo ($res["type"]); ?>">
                              <input type="hidden" name="pid" value="<?php echo ($res["pid"]); ?>">
                              <input type="hidden" name="id" value="<?php echo ($res["id"]); ?>">
                              <input type="hidden" name="salt" value="<?php echo ($res["salt"]); ?>">
                              <input type="hidden" name="path" value="<?php echo ($res["path"]); ?>">
                              <span class="help-inline red"> * </span>
                          </div>
                      </div>
                      <div class="form-group">
                          <label class="control-label">子分类名 : </label>
                          <div class="controls pull-left">
                              <input type="text" class="input-large" name="childtype">
                              <span class="help-inline red"> * </span>
                          </div>
                      </div>
                      <?php if(($res['salt']==1)): ?><div class="form-group">
                          <label class="control-label">在导航栏是否显示 : </label>
                          <div class="controls pull-left">
                      ...
                      <?php else: endif; ?> 
                      <div class="form-group">
                          <label class="control-label">子分类描述 : </label>
                          <textarea class="input-large" style="margin: 0px; height: 115px; width: 530px;" name="childcontent"></textarea>
                      </div>
                      <div class="form-group">
