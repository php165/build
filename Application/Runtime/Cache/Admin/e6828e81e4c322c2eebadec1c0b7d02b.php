              ...
              <div class="page-content">
                <div class="row">
                  <div class="page-content box">
                      ...
                      <form action="/commpany/build/index.php/Admin/Type/update/id/<?php echo ($res["id"]); ?>" method="post" class="form-horizontal">
                      <div class="form-group">
                          <label class="control-label">分类名: </label>
                          <div class="controls pull-left">
                              <input type="text" class="input-large" name="type" value="<?php echo ($res["type"]); ?>">
                              <span class="help-inline red"> * </span>
                          </div>
                      </div>
                      <?php if(($res['salt']==2)): ?><div class="form-group">
                          <label class="control-label">导航栏是否显示: </label>
                          <div class="controls pull-left">
                            <?php if(($res['isshow'] == 1)): ?><input type="radio" checked="checked" name="isshow" value="1">&nbsp;&nbsp;是&nbsp;&nbsp;
                              <input type="radio"  name="isshow" value="0">&nbsp;&nbsp;否
                              <span class="help-inline red"> * </span>
                            <?php else: ?>
                              <input type="radio"  name="isshow" value="1">&nbsp;&nbsp;是&nbsp;&nbsp;
                              <input type="radio" checked="checked" name="isshow" value="0">&nbsp;&nbsp;否
                              <span class="help-inline red"> * </span><?php endif; ?>
                          </div>
                      </div>
                      <?php else: endif; ?> 
                      <div class="form-group">
                          <label class="control-label">分类描述: </label>
                          <textarea class="input-large" style="margin: 0px; height: 115px; width: 530px;" name="content" value="content"><?php echo ($res["content"]); ?></textarea>
                      </div>
                      <div class="form-group">
                          <label class="control-label">是否启用: </label>
                          <?php if(($res['status'] == 1)): ?><input type="radio" checked="checked" name="status" value="1">&nbsp;是&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <div>
                          ...
                          <button id="bsubmit" type="submit"  class="btn btn-sm btn-primary">修改</button>
                      </div>
                  </form>
                    </div>
