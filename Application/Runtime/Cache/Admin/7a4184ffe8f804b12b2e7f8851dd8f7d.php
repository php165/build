            ...
            <div class="row">
              <div class="page-content box">
              	<div class="box-title margin_bot_20">
                  	<div class="span10">
                   		<h3><i class="icon-cogs"></i>内容管理 </h3>
                  	</div>
                </div>
                  <form class="form-horizontal" action="/commpany/build/index.php/Admin/Article/index" method="get">
                      <div class="form-group">
                          <label class="control-label"  style="padding-top:0; margin-right:10px;">
                              <select name="searchtype" id="searchtype" class="input-medium">
                                  ...
                                  <option <?php if($search == 'title'): ?>selected="selected" <?php else: endif; ?> value="title">标题</option>
                                  <option <?php if($search == 'content'): ?>selected="selected" <?php else: endif; ?> value="content">内容描述</option>
                          ...
                          <div align="right" style="margin-bottom:10px;">
                                  <a href="<?php echo U('Article/add');?>" class="btn btn-primary btn-sm"><i class="icon-plus"></i>添加内容</a>
                              </div>
                      </div>
                  </form>
                <div class="tableHead">
                ...
                <div id="table_hy">
                    <table class="table table_img table-striped table-bordered  table-hover">
                         <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                          ...
                          <td><img src="/commpany/build/Public<?php echo ($vo["mastermap"]); ?>" width="100px"></td>
                          ...
                          <td>
                              <?php switch($vo["istop"]): case "1": ?>是<?php break;?>
                                  <?php case "0": ?>否<?php break;?>
                                  <?php default: endswitch;?>
                          </td>
                          <td class="green information">
                            <a href="/commpany/build/index.php/Admin/Article/look/id/<?php echo ($vo["id"]); ?>" class="green cancel">查看</a><br/>
                            <a href="/commpany/build/index.php/Admin/Article/istop/id/<?php echo ($vo["id"]); ?>" class="green cancel">
                              <?php if(($vo["istop"] == 0) ): ?>显示在首页
                              <?php else: ?>禁止显示在首页<?php endif; ?>
                            </a><br/>
                            <a href="/commpany/build/index.php/Admin/Article/status/id/<?php echo ($vo["id"]); ?>" class="green cancel">
                              <?php if(($vo["status"] == 0) ): ?>启用
                              <?php else: ?>禁用<?php endif; ?>
                            </a><br/>
                            <a href="/commpany/build/index.php/Admin/Article/edit/id/<?php echo ($vo["id"]); ?>" class="green cancel">编辑</a><br/>
                            <a onclick="return confirm('您确定要删除吗')" href="/commpany/build/index.php/Admin/Article/del/id/<?php echo ($vo["id"]); ?>" class="green cancel">删除</a>
                          </td>
