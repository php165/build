          ...
          <div class="page-content">
            <div class="row">
              <div class="page-content box">
                  ...
                  <form class="form-horizontal" action="/commpany/build/index.php/Admin/Protect/index" method="get">
                      <div class="form-group">
                          <label class="control-label"  style="padding-top:0; margin-right:10px;">
                              <select name="searchtype" id="searchtype" class="input-medium">
                                  ...
                                  <option <?php if($search == 'title'): ?>selected="selected" <?php else: endif; ?> value="title">文章标题</option>
                    ...
                    <table class="table table_img table-striped table-bordered  table-hover">
                         <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                          ...
                          <td class="green information">
                            <a href="/commpany/build/index.php/Admin/Protect/look/id/<?php echo ($vo["id"]); ?>" class="green cancel">查看</a>
                            <a href="/commpany/build/index.php/Admin/Protect/status/id/<?php echo ($vo["id"]); ?>" class="green cancel">
                              <?php if(($vo["status"] == 0) ): ?>启用
                              <?php else: ?>禁用<?php endif; ?>
                            </a>
                            <a href="/commpany/build/index.php/Admin/Protect/edit/id/<?php echo ($vo["id"]); ?>" class="green cancel">编辑</a>
                            <a href="/commpany/build/index.php/Admin/Protect/del/id/<?php echo ($vo["id"]); ?>" class="green cancel">删除</a>
                          </td>
