        ...
        <div class="row">
            <div class="page-content box">
              <div class="box-title margin_bot_20">
                  ...
                  <form method="post" action="<?php echo U('Pic/insert');?>" enctype="multipart/form-data">
                      <div class="form-group">
                          <label class="control-label">轮播图 : </label><br/>
                              <span class="help-inline red"> * </span>
                              <img src="/commpany/build/Public/Uploads/default.png" style="width:150px;">
                              <input type="file" class="input-large" name="pic">
                          
                      </div>
                      <div class="form-group">
                          <label class="control-label">轮播图描述 : </label>
                          <textarea class="input-large" style="margin: 0px; height: 115px; width: 530px;" name="content"></textarea>
                      </div>
                      <div class="form-group">
