              ...
              <div class="page-content">
                <div class="row">
                  <div class="page-content box">
                      ...
                      <form method="post" action="/commpany/build/index.php/Admin/Cyclopedia/update/id/<?php echo ($res["id"]); ?>" enctype="multipart/form-data">
                      	<div class="span10">
                            <dl class="zc_dl">
                              <dt>标题：</dt>
                              <dd>
                            ...
                            <dl class="zc_dl">
                              ...
                              <dd>
                                ...
                                <input type="file"  name="mastermap" class="zc_btn" value="<?php echo ($res["mastermap"]); ?>" valid="required|limit"  min="20" max="40" errmsg="" />&nbsp;&nbsp;&nbsp;
