        ...
        <div class="row">
            <div class="page-content box">
                ...
                <div align="left" style="margin-bottom:10px;">
                    <form class="form-horizontal" action="/commpany/build/index.php/Admin/Type/index" method="get">
                          <div class="form-group">
                              <label class="control-label"  style="padding-top:0; margin-right:10px;">
                                  <select name="searchtype" id="searchtype" class="input-medium">
                                      ...
                                      <option <?php if($search == 'content'): ?>selected="selected" <?php else: endif; ?> value="content">分类描述</option>
                              ...
                              <div align="right" style="margin-bottom:10px;">
                                  <a href="<?php echo U('Type/add');?>" class="btn btn-primary btn-sm"><i class="icon-plus"></i>添加分类</a>
                              </div>
                          </div>
                      </form>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                        ...
                        <?php if(($vo['salt'] == 1)): ?><td><img src="/commpany/build/Public/Admin/images/dirfirst.gif" style="float: left;"><br/></td>

                        <?php elseif(($vo['salt'] == 2)): ?><td><img style="float: left;" src="/commpany/build/Public/Admin/images/dirsecond.gif"></td>
                        <?php else: ?><td><img style="float: left;" src="/commpany/build/Public/Admin/images/dirthird.gif"></td><?php endif; ?>
                        ...
                        <td>
                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                ...
                                <a class="status" name="status" href="/commpany/build/index.php/Admin/Type/status/id/<?php echo ($vo["id"]); ?>">
                                  <?php if(($vo['status'] == 0)): ?>启用
                                  <?php elseif(($vo['status'] == 1)): ?>禁用
                                  <?php else: endif; ?>
                                </a>
                                <input type="hidden" name="id" class="id" value="<?php echo ($vo["id"]); ?>">
                                <?php if(($vo['salt'] == 1 ) OR ( $vo['salt'] == 2 )): ?><a href="/commpany/build/index.php/Admin/Type/addchild/id/<?php echo ($vo["id"]); ?>">&nbsp;添加子分类</a><?php endif; ?>
                                <a class="green oppost" href="/commpany/build/index.php/Admin/Type/edit/id/<?php echo ($vo["id"]); ?>">
                                <i class="icon-pencil bigger-130"></i>&nbsp;编辑</a>
                                <a class="oppost red" onclick="return confirm('你确定要删除吗')" href="/commpany/build/index.php/Admin/Type/del/id/<?php echo ($vo["id"]); ?>"><i class="icon-remove bigger-130"></i>&nbsp;删除</a>
                            </div>
                        </td>
