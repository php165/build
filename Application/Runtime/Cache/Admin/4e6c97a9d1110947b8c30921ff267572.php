        ...
        <div class="row">
            <div class="page-content box">
              <div class="box-title margin_bot_20">
                    <div class="span10">
                    <h4><span style="float:right;"><a href='/commpany/build/index.php/Admin/Pic/index'>返回</a></span></h4>
                        <h3><i class="icon-magic"></i>添加轮播图</h3>
                    </div>
                </div>
                  <form method="post" action="<?php echo U('Pic/update');?>" enctype="multipart/form-data">
                      <div class="form-group">
                          <p><label class="control-label">轮播图 : </label></p>
                              <input type="file" class="input-large" name="pic">
                              <input type="hidden" name="id" value="<?php echo ($res["id"]); ?>">
                              <img src="/commpany/build/Public<?php echo ($res["pic"]); ?>" style="width:200px;">
                          
                      </div>
                      <div class="form-group">
                          <p><label class="control-label">轮播图描述 : </label></p>
                          <textarea class="input-large" style="margin: 0px; height: 115px; width: 530px;" name="content"><?php echo ($res["content"]); ?></textarea>
                      </div>
                      <div class="form-group">
                          <label class="control-label">是否启用 : </label>
                          <?php if(($res['status']==0)): ?><input type="radio" name="status" value="1">&nbsp;是&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="status" checked="checked" value="0">&nbsp;否
                          <?php else: ?>
                            <input type="radio" name="status"  checked="checked" value="1">&nbsp;是&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="status" checked="checked" value="0">&nbsp;否<?php endif; ?>  
                      </div>
                      <div>
