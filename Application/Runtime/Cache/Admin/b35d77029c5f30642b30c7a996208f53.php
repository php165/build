            ...
            <div class="row">
              <div class="page-content box">
              	<div class="box-title margin_bot_20">
                  	<div class="span10">
                   		<h3><i class="icon-cogs"></i>角色管理 </h3>
                  	</div>
                </div>
                  <form class="form-horizontal" action="/commpany/build/index.php/Admin/Role/index" method="get">
                      <div class="form-group">
                          <label class="control-label"  style="padding-top:0; margin-right:10px;">
                              <select name="searchtype" id="searchtype" value="<?php echo ($search); ?>" class="input-medium">
                                  ...
                                  <!-- <option <?php if($search == 'id'): ?>selected='selected' <?php else: endif; ?> value="id">角色ID</option> -->
                                  <option <?php if($search == 'role'): ?>selected='selected' <?php else: endif; ?> value="role">角色名</option>
                          ...
                          <div align="right" style="margin-bottom:10px;">
                                  <a href="<?php echo U('Role/add');?>" class="btn btn-primary btn-sm"><i class="icon-plus"></i>添加角色</a>
                              </div>
                      </div>
                  </form>
                <div class="tableHead">
                    ...
                    <table class="table table_img table-striped table-bordered  table-hover">
                         <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                            ...
                            <td class="green information">
                                <!-- <a href="/commpany/build/index.php/Admin/Role/edit/id/<?php echo ($vo["id"]); ?>" class="green cancel">修改</a> -->
                                <a href="/commpany/build/index.php/Admin/Role/status/id/<?php echo ($vo["id"]); ?>" class="green cancel">
                                      <?php if(($vo["status"] == 1) ): ?>启用
                                      <?php else: ?>禁用<?php endif; ?>
                                </a>
                                <a onclick="return confirm('您确定要删除吗')" href="/commpany/build/index.php/Admin/Role/del/id/<?php echo ($vo["id"]); ?>" class="green cancel">删除</a>
                            </td>
